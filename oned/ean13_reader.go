...
//
// params: resultString string to insert decoded first digit into
// params: lgPatternFound int whose bits indicates the pattern of odd/even L/G patterns used to
//
//	encode digits
//
